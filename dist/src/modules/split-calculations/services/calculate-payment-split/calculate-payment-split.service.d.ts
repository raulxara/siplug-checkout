...
export declare class CalculatePaymentSplitService {
    ...
    constructor(findSplitRuleByUniqueIdService: FindSplitRuleByUniqueIdService, getAllSplitRuleRecipientsBySplitRuleIdService: GetAllSplitRuleRecipientsBySplitRuleIdService, findSplitRecipientByUniqueIdService: FindSplitRecipientByUniqueIdService);
