...
exports.MarkPaymentWebhookEventAsFailedService = void 0;
...
const mark_payment_webhook_event_as_failed_dto_out_1 = require("./dtos/mark-payment-webhook-event-as-failed.dto-out");
let MarkPaymentWebhookEventAsFailedService = class MarkPaymentWebhookEventAsFailedService {
    repository;
    ...
    async exec(dtoIn) {
        ...
        return new mark_payment_webhook_event_as_failed_dto_out_1.MarkPaymentWebhookEventAsFailedDtoOut(updated);
    }
    buildOldData(row) {
        return {
...
exports.MarkPaymentWebhookEventAsFailedService = MarkPaymentWebhookEventAsFailedService;
exports.MarkPaymentWebhookEventAsFailedService = MarkPaymentWebhookEventAsFailedService = __decorate([
...
//# sourceMappingURL=mark-payment-webhook-event-as-failed.service.js.map