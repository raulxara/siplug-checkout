...
exports.MarkPaymentWebhookEventAsProcessingService = void 0;
...
const mark_payment_webhook_event_as_processing_dto_out_1 = require("./dtos/mark-payment-webhook-event-as-processing.dto-out");
let MarkPaymentWebhookEventAsProcessingService = class MarkPaymentWebhookEventAsProcessingService {
    repository;
    ...
    async exec(dtoIn) {
        ...
        if (current.status === 'processed') {
            return new mark_payment_webhook_event_as_processing_dto_out_1.MarkPaymentWebhookEventAsProcessingDtoOut(current);
        }
        const newData = {
            status: 'processing',
        };
        ...
        return new mark_payment_webhook_event_as_processing_dto_out_1.MarkPaymentWebhookEventAsProcessingDtoOut(updated);
    }
    buildOldData(row) {
        return {
            status: row.status,
...
exports.MarkPaymentWebhookEventAsProcessingService = MarkPaymentWebhookEventAsProcessingService;
exports.MarkPaymentWebhookEventAsProcessingService = MarkPaymentWebhookEventAsProcessingService = __decorate([
...
//# sourceMappingURL=mark-payment-webhook-event-as-processing.service.js.map