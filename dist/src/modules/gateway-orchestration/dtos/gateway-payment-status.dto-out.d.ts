export declare class GatewayPaymentStatusDtoOut {
    ...
    constructor(success: boolean, provider: string, gatewayTransactionId: string | null, gatewayStatus: string | null, status: string, processStatus: string, processMessage: string, providerRequest: Record<string, unknown> | null, providerResponse: Record<string, unknown> | null, gatewayResponse: Record<string, unknown> | null, qrCode?: string | null, qrCodeBase64?: string | null, boletoUrl?: string | null, checkoutUrl?: string | null, paidAt?: string | null, authorizedAt?: string | null, canceledAt?: string | null, failedAt?: string | null, refundedAt?: string | null, expiresAt?: string | null);
}
