...
let InfinityPayGatewayPaymentProvider = class InfinityPayGatewayPaymentProvider extends unsupported_gateway_payment_provider_1.UnsupportedGatewayPaymentProvider {
    constructor() {
        super('infinity_pay', [
            'infinity_pay',
            'infinitypay',
