...
let GatewaysRepository = class GatewaysRepository {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(entity) {
        ...
        const fresh = new gateway_entity_1.GatewayEntity(this);
        fresh.id = model.id;
...
exports.GatewaysRepository = GatewaysRepository = __decorate([
