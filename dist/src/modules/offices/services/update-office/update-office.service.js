...
const update_office_dto_out_1 = require("./dtos/update-office.dto-out");
let UpdateOfficeService = class UpdateOfficeService {
    repository;
    ...
    async exec(dtoIn) {
        try {
            ...
            return new update_office_dto_out_1.UpdateOfficeDtoOut(row);
        }
        catch (error) {
            const message = error instanceof Error ? error.message : 'error on update office';
...
exports.UpdateOfficeService = UpdateOfficeService = __decorate([
...
//# sourceMappingURL=update-office.service.js.map