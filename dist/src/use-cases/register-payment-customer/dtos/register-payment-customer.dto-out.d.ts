...
export declare class RegisterPaymentCustomerDtoOut {
    readonly id: number;
    readonly _id: string;
    ...
    static fromCreatePaymentCustomerDtoOut(dtoOut: CreatePaymentCustomerDtoOut): RegisterPaymentCustomerDtoOut;
}
