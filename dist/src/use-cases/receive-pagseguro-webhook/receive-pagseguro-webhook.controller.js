...
exports.ReceivePagSeguroWebhookController = void 0;
...
let ReceivePagSeguroWebhookController = class ReceivePagSeguroWebhookController {
    ...
    async handle(apiCredentialId, body, headers, request) {
        ...
        return {
            status: 'success',
            message: 'pagseguro webhook received successfully',
            data: {
...
exports.ReceivePagSeguroWebhookController = ReceivePagSeguroWebhookController;
__decorate([
    (0, common_1.Post)('pagseguro/:apiCredentialId'),
...
], ReceivePagSeguroWebhookController.prototype, "handle", null);
exports.ReceivePagSeguroWebhookController = ReceivePagSeguroWebhookController = __decorate([
...
//# sourceMappingURL=receive-pagseguro-webhook.controller.js.map