...
exports.DevMercadoPagoCardTokenPageController = void 0;
const common_1 = require("@nestjs/common");
let DevMercadoPagoCardTokenPageController = class DevMercadoPagoCardTokenPageController {
    handle(publicKey, amount, checkoutSessionId) {
...
exports.DevMercadoPagoCardTokenPageController = DevMercadoPagoCardTokenPageController;
__decorate([
    (0, common_1.Get)('card-token-page'),
    (0, common_1.Header)('Content-Type', 'text/html; charset=utf-8'),
    __param(0, (0, common_1.Query)('publicKey')),
    __param(1, (0, common_1.Query)('amount')),
    __param(2, (0, common_1.Query)('checkoutSessionId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", String)
], DevMercadoPagoCardTokenPageController.prototype, "handle", null);
exports.DevMercadoPagoCardTokenPageController = DevMercadoPagoCardTokenPageController = __decorate([
    (0, common_1.Controller)('dev/mercado-pago')
], DevMercadoPagoCardTokenPageController);
//# sourceMappingURL=dev-mercado-pago-card-token-page.controller.js.map