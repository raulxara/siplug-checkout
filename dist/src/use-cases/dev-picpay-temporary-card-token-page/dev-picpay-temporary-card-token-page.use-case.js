...
exports.DevPicPayTemporaryCardTokenPageUseCase = void 0;
...
const dev_picpay_temporary_card_token_page_dto_out_1 = require("./dtos/dev-picpay-temporary-card-token-page.dto-out");
let DevPicPayTemporaryCardTokenPageUseCase = class DevPicPayTemporaryCardTokenPageUseCase {
    ...
    resolveMerchantCredential(config) {
        if (config === null) {
            throw new Error('api credential config is required');
        }
        const merchantCredential = this.toNullableString(config.merchantCredential) ??
        ...
        if (merchantCredential === null) {
            throw new Error('PicPay merchantCredential is required in api credential config');
        }
        return merchantCredential.replace(/\D/g, '');
    }
    resolveTransparentToken(config) {
        if (config === null) {
            throw new Error('api credential config is required');
        }
        const transparentToken = this.toNullableString(config.transparentToken) ??
        ...
        if (transparentToken === null) {
            throw new Error('PicPay transparentToken is required in api credential config');
        }
    ...
    resolveEnvironment(config) {
        ...
        const environment = this.toNullableString(config.environment) ??
...
exports.DevPicPayTemporaryCardTokenPageUseCase = DevPicPayTemporaryCardTokenPageUseCase;
exports.DevPicPayTemporaryCardTokenPageUseCase = DevPicPayTemporaryCardTokenPageUseCase = __decorate([
...
//# sourceMappingURL=dev-picpay-temporary-card-token-page.use-case.js.map