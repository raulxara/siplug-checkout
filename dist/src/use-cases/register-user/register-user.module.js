...
exports.RegisterUserModule = RegisterUserModule = __decorate([
    (0, common_1.Module)({
        imports: [
        ...
        providers: [register_user_use_case_1.RegisterUserUseCase],
        exports: [register_user_use_case_1.RegisterUserUseCase],
    })
], RegisterUserModule);
