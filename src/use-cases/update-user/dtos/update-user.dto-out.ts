...
export class UpdateUserDtoOut {
  constructor(
    ...
    public readonly createdUserPositions: UserPositionRow[],
    public readonly activatedUserPositions: UserPositionRow[],
    public readonly inactivatedUserPositions: UserPositionRow[],
  ) {}
}