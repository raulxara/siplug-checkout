...
export class UpdateSubscriptionService {
  ...
  ): Promise<UpdateSubscriptionDtoOut> {
    try {
  ...
  private buildChangesHistory(params: {
    ...
    this.appendChange(
      ...
      newValues,
      'currentCycle',
      params.current.currentCycle,
      params.dtoIn.currentCycle,
    );
    this.appendChange(
      oldValues,
      newValues,
      'nextBillingAt',
      params.current.nextBillingAt,
      params.dtoIn.nextBillingAt,
    );
    this.appendChange(
      oldValues,
      newValues,
      'startedAt',
      params.current.startedAt,
      params.dtoIn.startedAt,
    );
    this.appendChange(
      oldValues,
      newValues,
      'canceledAt',
      params.current.canceledAt,
      params.dtoIn.canceledAt,
    );
    this.appendChange(
      oldValues,
      newValues,
      'endedAt',
      params.current.endedAt,
      params.dtoIn.endedAt,
    );
    this.appendChange(
      oldValues,
      newValues,
    ...
    this.appendChange(
      ...
      params.current.gatewaySubscriptionId,
      params.dtoIn.gatewaySubscriptionId,
    );
